...
const randomImages = [img7, img8, img9, img10, img11, img12];
          ...
          <Link to="/admins">
            <li className="current">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g fill="" id="User Arrows/ 24 / Solid">
                  <path
                    id="Vector"
      ...
      <div className="admins-page">
        <header>
          ...
          <div className="Admin-admin">
            <img className="Admin-Image" src={Admin} alt="Admin_Image" />
        ...
        <div className="employers">
          <div className="head">
            ...
            />
            <select name="admin-filter" id="filter">
          ...
          <div className="admins-list-container">
            {userList
              ...
              .map((adminUser) => (
                <div className="admin-name-list" key={adminUser.id}>
                  ...
                  <p className="admin-name-details">
