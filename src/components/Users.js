...
export default function Users() {
  ...
  useEffect(() => {
    // Fetchs the list of users using the auth token
    if (token) {
      ...
      <div className="users-page">
        ...
        <div className="employers">
          <div className="head">
            ...
            />
            <select name="user-filter" id="filter">
          ...
          <div className="users-list-container">
            {userList
              ...
              .map((adminUser) => (
                <div className="user-name-list" key={adminUser.id}>
